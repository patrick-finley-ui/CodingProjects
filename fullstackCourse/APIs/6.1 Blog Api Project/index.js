...
app.patch("/posts/:id", (req, res) => {
  ...
  const editPostIndex = posts.findIndex((post => post.id === postId));
  const oldPost = posts[editPostIndex];
  const editPost = {
    id: postId,
  ...
  console.log(editPost + " index: " + editPostIndex);
  posts[editPostIndex] = editPost;
  res.send(editPost)
})
