...
app.post("/jokes", (req, res) => {
  const newjoke = {
    id: jokes.length + 1,
    jokeText: "Why did Pat say hi? because he was alone",
    jokeType: "Puns",
  };
  jokes.push(newjoke);
  res.send(newjoke);
...
app.put("/jokes/:id", (req, res) => {
  ...
  // Optionally, use data from req.body if provided, otherwise use defaults
  const newjoke = {
    id: id,
    jokeText: req.body.jokeText || "Why did Pat say hi? because he was Pat",
    jokeType: req.body.jokeType || "Puns",
  };
...
app.delete("/all", (req, res) => {
  ...
  if (req.query.key === masterKey) {
    jokes = [];
    res.send({ message: "All jokes deleted successfully" });
